    ...
    if (menuButtons) {
        ...
        menuButtons.forEach((button => {
            button.addEventListener("click", (function() {
                ...
                const targetClass = this.classList.contains("btn-menu-profile") ? "item-profile" : this.classList.contains("btn-menu-faq") ? "item-faq" : this.classList.contains("btn-menu-transaction") ? "item-transaction" : "";
                if (currentlyActiveItem) currentlyActiveItem.classList.remove("_show-item");
                contentItems.forEach((item => {
                    if (item.classList.contains(targetClass)) item.classList.add("_show-item");
                }));
            }));
        }));
